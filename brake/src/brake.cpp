...
void brakeCallback(const std_msgs::Int16::ConstPtr& msg)
{
  set_brake(msg->data);
...
// %Tag(SUBSCRIBER)%
  ros::Subscriber sub = n.subscribe<std_msgs::String>("brake", 1, chatterCallback);
  ros::Subscriber sub2 = n.subscribe<std_msgs::Int16>("brake_perc", 1, brakeCallback);
// %EndTag(SUBSCRIBER)%
write_access();	
enable_bridge();
find_limits();	
